...
if(server)
    add_definitions(-DORCHID_SERVER)
    set(APPVERSION "0.1.0 GIT")
elseif(qmlui)
...
# Installation paths
if (WIN32)
    set(INSTALLROOT "$ENV{SystemDrive}/orchidlights")
elseif (APPLE)
    set(INSTALLROOT "$ENV{HOME}/OrchidLights.app/Contents")
elseif (UNIX)
    set(INSTALLROOT "/usr")
endif ()
...
elseif (UNIX)
    set(DATADIR "share/orchidlights")
endif ()
...
# User Data
# NOTE: the daemon must fall back to the legacy QLC+ user directory (~/.qlcplus
# and friends) when this one does not exist, so that custom .qxf profiles and
# input profiles carry over. Tracked as an F1 acceptance criterion.
if (WIN32)
    set(USERDATADIR "OrchidLights")
elseif (APPLE)
    set(USERDATADIR "Library/Application Support/OrchidLights")
elseif (UNIX)
    set(USERDATADIR ".orchidlights")
endif ()
...
elseif (UNIX)
    if (appimage)
        set(PLUGINDIR "../lib/qt${QT_MAJOR_VERSION}/plugins/orchidlights")
    else ()
        set(PLUGINDIR "${LIBSDIR}/qt${QT_MAJOR_VERSION}/plugins/orchidlights")
    endif ()
endif ()
...
if (UNIX AND NOT APPLE)
    ...
    if (${inUsr} EQUAL 0)
        ...
        string(REPLACE "/usr/" "" PLUGINDIR "${QTPLUGINSDIR}/orchidlights")
        set(AUDIOPLUGINDIR "${PLUGINDIR}/audio")
    endif()
